// https://www.tutorialspoint.com/cprogramming/c_command_line_arguments.htm --> Keep Learning.
...
especially when you want to control your program from outside instead of hard coding those values inside the code.
...
first command line argument supplied, and *argv[n] is the last argument.
...
Let us re-write above example once again where we will print program name and we also pass a
...
/**/
/*
When the above code is compiled and executed with a single argument separated by space but inside double quotes,
...
Pass Arguments by the command line
*/
