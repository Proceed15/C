// https://www.tutorialspoint.com/cprogramming/c_error_handling.htm --> Keep Learning.
...
exit with a status EXIT_FAILURE which is defined as -1. So let's write above program as follows −
*/
/**/
#include <stdio.h>
#include <stdlib.h>
