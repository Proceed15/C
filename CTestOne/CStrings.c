// https://www.tutorialspoint.com/cprogramming/c_strings.htm --> Keep Learning.
...
// hold the null character at the end of the array, the size of the character array containing the string is one more than the
