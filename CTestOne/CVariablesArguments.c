// https://www.tutorialspoint.com/cprogramming/c_variable_arguments.htm --> Keep Learning.
...
i.e., parameters, instead of predefined number of parameters.
...
It should be noted that the function average() has been called twice and each time the first argument
